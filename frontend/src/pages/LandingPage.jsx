...
export default function LandingPage() {
  ...
  return (
   <div className="min-h-screen bg-white font-sora relative">
      ...
      <div className="hero-content text-center space-y-10 mt-10 px-4 pt-20 z-10">
        ...
        <button
          ...
          className="button-login px-6 py-3 bg-[#FF4911] text-white text-lg font-semibold border-3 border-black rounded-xl shadow-[0_6px_0_rgba(0,0,0,1)] hover:-translate-y-1 hover:shadow-[0_8px_0_rgba(0,0,0,1)] active:-translate-y-0 active:shadow-[0_4px_0_rgba(0,0,0,1)] transition-all duration-100"
        >
          Start Your Journey
        </button>
      </div>
